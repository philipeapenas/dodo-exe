# Dodo.exe Workspace - System Prompt & Skill Router (Codex e Antigravity)
...
## Workflow de Execucao do Codex e Antigravity
...
Este arquivo (`AGENTS.md`) e **gerado automaticamente** a partir do `CLAUDE.md`, que
